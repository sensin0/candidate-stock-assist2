...
- `scripts/weekly_cloud_ranker.py` reads `cyclical_tickers.csv`, fetches latest market and financial data with `yfinance`, builds a turnaround-style ranking, and sends the top results to Discord.
